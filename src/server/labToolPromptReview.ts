...
export async function reviewLabToolPrompt(
  ...
  const instruction = [
    ...
    "判斷學生提示詞是否和目前題目及指定媒體類型大致相符。",
    "只要主題、產出類型與主要需求大致正確就通過，不要因為少量細節、錯字或用詞不同擋下。",
    "請接受國小學生用語、短句、錯字、口語描述。",
    "請擋下：亂打、只寫「生成圖片/生成音樂」這類空泛內容、與題目明顯無關、用錯工具、缺少題目最重要主題。",
    "不通過時，feedback 要直接告訴學生少了什麼，最多 45 個中文字。",
    "只輸出 JSON，不要加解釋。",
